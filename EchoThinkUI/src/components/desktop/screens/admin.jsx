                  ...
                  {home && (
                    <div className="flex flex-col items-center justify-center h-full p-4 text-center">
                      ...
                      <button
                        ...
                        className="mt-5 w-1/12 bg-red-500 text-white p-2 rounded"
                      >
                        SAIR
                      </button>
                    </div>
                                ...
                                <td className=" border-gray-400 p-2 border">
                                  {p.image_url ? (
                                    <img
                                      src={p.image_url}
                                      alt="Pergunta"
                                      className="border max-w-[100px] max-h-[100px] object-cover "
                                    />
                                  ) : (
                                    "-"
                                  )}
                  ...
                  {listarParticipantes && (
                    <div className="w-full overflow-auto flex flex-col justify-start items-center">
                      ...
                      {loadingParticipantes ? (
                        ...
                        <table className="border w-full min-w-[600px] border-collapse border-gray-400">
                          <thead>
                            <tr className="bg-gray-700">
                          ...
                          <tbody>
                            {listarParticipantesArray.map((p) => (
                              <tr key={p.id}>
                                <td className="border border-gray-400 p-2 text-center text-white">
                                  {p.nome}
                                </td>
                                <td className="border border-gray-400 p-2 text-center text-white">
                                  {p.telefone}
